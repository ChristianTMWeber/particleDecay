...
int main(int argc, char *argv[]) {
	...
	//test the += operator
	n=14;
	ThreeVector v14(0,0,0);
	v14+=v12;
	allElementsEqual(n,v14,v12);

	//Test + operator
	n=15;
	ThreeVector v15summand(0,0,0),v15sum(0,0,0),v15check(0,0,0);
	...
	n=18;
	ThreeVector v18product(0,0,0), v18factor(95,-7,22);
	ThreeVector v18Check = v18factor;
	int scalarFactor = 3;
	...
	//Test / operator
	n=26;
	ThreeVector v25dividend(2,4,8), v25quotient;
	...
	//Test unary - operator
	n=28;
	ThreeVector v28(0,0,0);
	allElementsEqual(n,-v24quotient,v28-v24quotient);

	//Test dot-product
	n=29;
	ThreeVector v29(1,2,3);
	allElementsEqual(n,v29*v29,double(14));

	//Test abs() function
	n=30;
	ThreeVector v30(1,2,2);
	allElementsEqual(n,abs(v30),double(3));

	//Test cross() method
	n=31;
	ThreeVector v31c(8,3,6),v31b(-7,1,2),v31a(0,-58,29);
	allElementsEqual(n,v31c.cross(v31b),v31a);

	//Test array subscriting -- value reading
	n=32;
	ThreeVector v32a(1,2,3);
	ThreeVector v32b(v32a[0],v32a[1],v32a[2]);
	allElementsEqual(n,v32a,v32b);

	//Test array subscriting -- value setting
	n=33;
	ThreeVector v33(4,5,6);
	v32a[0]=v33.x(); 	v32a[1]=v33.y();	v32a[2]=v33.z();
	allElementsEqual(n,v32a,v33);

	//Test .rotateX method
	n=34;
	ThreeVector v34(0,0,1), v34rotated,v34target(0,-1,0);
	v34rotated=v34.rotateX(pi/2);
	vectorsEqualWithinAccucary(n,v34rotated,v34target);

	//Test .rotateY method
	n=35;
	ThreeVector v35(1,1,1), v35rotated,v35target(sqrt(2),1,0);
	v35rotated=v35.rotateY(pi/4);
	vectorsEqualWithinAccucary(n,v35rotated,v35target);

	//Test .rotateZ method
	n=36;
	ThreeVector v36(10,-2,4), v36rotated,v36target(1+5*sqrt(3),5-sqrt(3),4);
	v36rotated=v36.rotateZ(pi/6);
	vectorsEqualWithinAccucary(n,v36rotated,v36target);
	
	//Test .unit method
	n=37;
	ThreeVector v37(2,0,0),v37target(1,0,0);
	ThreeVector v37copy=v37;
	...
	ThreeVector v43out(2,3,5),v43in;
	...
	*/
	...
	n=45;
	ThreeVector v45a(96,66,4),v45b(76,4,32),v45c(75,28,96);
	ThreeVector v45RotateMe = v45b;
